...
.container
  .flex.flex-row
    ...
    div.px-6(class="lg:px-12 w-full lg:w-9/12 xl:w-8/12")
      //- .sticky.top-0.pt-12.bg-gradient-to-b.from-white.to-transparent(v-if="layoutSettings.scrollFaders") not working properly in mobile
      //- pre {{content}}
      slot
      //- .sticky.bottom-0.p-10.bg-gradient-to-b.from-transparent.to-white(v-if="layoutSettings.scrollFaders") not working properly in mobile
      CFooter
